...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { avatar: @professor.avatar, display_name: @professor.display_name, email: @professor.email, full_name: @professor.full_name, website: @professor.website } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { avatar: @professor.avatar, display_name: @professor.display_name, email: @professor.email, full_name: @professor.full_name, website: @professor.website } }
